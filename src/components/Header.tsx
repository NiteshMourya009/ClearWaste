...
//     if (isAdmin) {
//       // Admin login logic with user ID and password validation
//       if (!adminUserId || !adminPassword) {
//         alert("Please enter both User ID and Password");
//         return;
//       }

//       // Implement actual admin login authentication logic here
...
//                       User Login
//                     </DropdownMenuItem>
//                     <DropdownMenuItem onClick={() => setShowAdminLoginForm(true)}>
//                       Admin Login
//                     </DropdownMenuItem>
//                   </DropdownMenuContent>
//                 </DropdownMenu>
...
//               </DropdownMenuTrigger>
//               <DropdownMenuContent align="end">
//                 <DropdownMenuItem>{userInfo ? userInfo.name : "Fetch User Info"}</DropdownMenuItem>
//                 <DropdownMenuItem>
//                   <Link href="/settings">Profile</Link>
//                 </DropdownMenuItem>
//                 <DropdownMenuItem>Settings</DropdownMenuItem>
